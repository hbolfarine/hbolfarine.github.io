...
author: "Class 06 - Modeling nonlinear relationships"
...
utilities = read.csv("week_06_docs/utilities.csv")
options(scipen = 999)
```
...
![](week_06_docs/exp_log.png){fig-align="center" width="50%"}
...
![](week_06_docs/exp_normal.png){fig-align="center" width="50%"}
...
```{r}
moores = read.csv("week_06_docs/moores-law.csv")
```
...
| Log-linear | $\log(\widehat{Y}) = \widehat{\beta}_0 + \widehat{\beta}_1 X$ | 1 unit increase in $X$ implies $(\exp(\widehat{\beta}_1)-1)\times 100\%$ |
