...
author: "Class 10 - Randomized Control Trials"
...
![](week_10_docs/confounders_class_09.png){fig-align="center" width="500"}

## Randomization {.smaller}

-   Due to **randomization**, we know that the treatment is **not affected** by a confounder

![](week_10_docs/randomization_class_09.png){fig-align="center" width="500"}
...
![](week_10_docs/image_dice_random.png){fig-align="center" width="500"}
...
![](week_10_docs/block_01.png){fig-align="center" width="700"}

## Blocking {.smaller}

-   **Blocking or stratification** sample

![](week_10_docs/block_02.png){fig-align="center" width="700"}
...
![](week_10_docs/block_03.png){fig-align="center" width="800"}
...
```{r}
GOTV = read.csv("week_10_docs/GOTV.csv")
```
...
-   The [average treatment effect]{style="color:darkorange;"} is the treatment coefficient on the **probability** scale: about **4.2 percentage points** higher predicted turnout in the treatment group.

```{r}
#| eval: true
#| echo: false
#| output: true
coef(vote_lm)["treatmenttreatment"]
confint(vote_lm)["treatmenttreatment", ]
```
