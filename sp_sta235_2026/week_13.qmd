...
author: "Class 13 - Logistic regression 2"
...
banco = read.csv("week_13_docs/banco.csv")
options(scipen = 999)
library(tidyverse)
```
...
-   To measure the model's accuracy on out sample data, methods as cross validation.
