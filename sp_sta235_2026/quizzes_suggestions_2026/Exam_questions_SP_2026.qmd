...
-   `experience` - level experience of the user
-   `frequency` - frequency on the number of workouts during the week
...
Create a model predicting the number of calories burn in relation to experience and workout type.
