...
author: "Class 11 - Natural experiments and RDD"
...
school = read.csv("week_11_docs/school.csv")
sales = read.csv("week_11_docs/school.csv")
options(scipen = 999)
library(tidyverse)
library(tidymodels)
```
...
![](week_11_docs/atlantic.png){fig-align="center" width="500"}
...
![](week_11_docs/nature.png){fig-align="center" width="500"}
...
![](week_11_docs/pa-nj.png){fig-align="center" width="500"}
...
![](week_11_docs/diff_diff_2025.png){fig-align="center" width="500"}
...
::: center
![](week_11_docs/rdd.png){fig-align="center" width="500"}
:::
...
-   The coefficient on (T) ((\hat\beta\_2)) is our estimate of the causal effect of the treatment.
