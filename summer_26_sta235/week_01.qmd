...
-   **Instructor:** **Henrique Bolfarine, Ph.D.**
    -   **Office hours:** Thursdays online after the syncronos class
    -   **Email:** [henrique.bolfarine\@austin.utexas.edu](mailto:henrique.bolfarine@austin.utexas.edu){.email}
-   **Course Assistants:**
    -   **Office hours:** TA/CA office hours every week (on Zoom) - **This should be your first option!**
    -   Mihir Gokhale and Hung-Lun schedule will be on Canvas.
...
::::: columns
::: {.column width="60%"}
-   Homeworks are done through Canvas.
    -   Homework 1 (Classes covered 1–9): Sunday, 06/21 - 11:59 PM
    -   Homework 2 (Classes covered 10–16): Sunday, 07/05 - 11:59 PM
-   Automatically graded; and you have three attempts.
...
-   Checkpoint Quiz at the [**start of the class**]{style="color: red;"} will help you ensure that you are really learning the material and give you an early heads-up if you aren't.

## Checkpoint Quizzes

-   Quiz 1 (Classes covered 1–5):
    -   Monday, 06/15
-   Quiz 2 (Classes covered 6–10):
    -   Monday, 06/23
-   Quiz 3 (Classes covered 11–16):
    -   Monday, 07/06

## Mastery Exams

-   Each unit concludes with a Mastery Exam:
    -   **Exam A:** June 25 during class hours
    -   **Exam B:** July 09 during class hours
-   You'll have access to RStudio using Posit and a "cheat sheet" during exams (don't spend time memorizing anything!).

------------------------------------------------------------------------

## Presentation - Project {.smaller}

<!-- ## Assessment Grading -->

-   The presentation must address the provided scenario, data, and questions within a strict 10-minute time limit (going over will result in a point deduction).
-   A Q&A session will follow, where the instructor will ask the group one question and randomly select one member to answer it.
-   You must use and explicitly display the methods and code presented in class for your analysis.
-   AI-generated code is strictly prohibited.
-   Points will be deducted if you use code that was not covered in the course.
-   Groups will consist of five members, chosen completely at random by the instructor.
...
| Homework (2)           | **150**    |
| Checkpoint Quizzes (3) | **300**    |
| Exam A                 | **175**    |
| Exam B                 | **175**    |
| Presentation - Project | **150**    |
| **Total**              | **1,000**  |
:::
