...
- [Randomly]{style="color:darkorange;"} assign the $X$, [“treatment”]{style="color:darkorange;"}, to participants
...
1. Check for balance - (balance between the treated and untreated)
...
- [*Fact*]{style="color:darkorange;"}: lots of people don’t vote.
