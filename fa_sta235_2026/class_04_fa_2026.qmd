...
author: "Class 04 - Categorical Variables"
title-slide-attributes:
    data-background-image: class_04_docs/background_sta235h.png
format: 
  revealjs:
    chalkboard: true
    logo: class_04_docs/texas_logo2.png
    toc: true
...
profs <- read.csv("class_04_docs/profs.csv")
options(scipen = 999)
```
