...
title-slide-attributes:
    data-background-image: class_03_docs/background_sta235h.png
format: 
  revealjs:
    chalkboard: true
    logo: class_03_docs/texas_logo2.png
    toc: true
...
linear_data = read.csv("class_03_docs/linear_data.csv")
nonlinear_data = read.csv("class_03_docs/nonlinear_data.csv")
non_normal = read.csv("class_03_docs/nonnormal_data.csv")
heter_data = read.csv("class_03_docs/heter_data.csv")
outlier_residual = read.csv("class_03_docs/outlier_data.csv")
...
```{r}
outlier_residual = read.csv("class_03_docs/outlier_residual.csv")
```
...
```{r}
outlier_leverage = read.csv("class_03_docs/outlier_leverage.csv")
```
...
```{r}
outlier_influence = read.csv("class_03_docs/outlier_influence.csv")
```
